...
public class Book {
    ...
    public Book(String title, Set<Author> authors, Set<Kinds> kinds) {
        this.title = title;
    ...
    public static Book newEdition(String title, Set<Author> authors, Set<Kinds> kinds, Publisher publisher, Integer editionNumber) {
        Book book = new Book(title, authors, kinds);
